...
?>
  ...
  <div class="hero-slider">
    <div data-glide-el="track" class="glide__track">
      ...
      <?php
        $homeSlide = new WP_Query(array(
          'posts_per_page' => -1,
          'post_type' => 'slide',
        ));

        while($homeSlide->have_posts()){
          $homeSlide->the_post();
      ?>

        <div class="hero-slider__slide" style="background-image: url(<?php $homeSlideImage = get_field('image_background'); echo $homeSlideImage['url']; ?>);">
